...
- [`as.data.frame(`*`<fair_assessment>`*`)`](https://choxos.github.io/rfair/reference/as.data.frame.fair_assessment.md)
...
- [`plot(`*`<fair_assessment>`*`)`](https://choxos.github.io/rfair/reference/plot.fair_assessment.md)
